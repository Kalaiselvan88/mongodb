...
class ControllerTest extends BrowserTestBase {
  ...
  /**
   * Gets the count of MongoDB log entries by database log event type.
   *
   * @param $types
   ...
   */
  public function ZtestLoggerReportsAccess() {
    $expectations = [
   ...
   */
  public function ZtestLoggerAddAndUiClear() {
  ...
  public function testFilter() {
    ...
    foreach ($typeNames as $typeName) {
      ...
      $count = $this->assertTypeCount($types);
      $this->assertEquals(array_sum($count), $typeCount, 'Count matched');
    }
    ...
    foreach ($types as $key => $type) {
      ...
      $count = $this->assertTypeCount($types);
      $this->assertEquals(array_sum($count), $type['count'], 'Count matched');
    }
  }
